...
local function call(translation, format, locale, query)
	assert(utils.check_command_exist("diatheke"), "diatheke command does not exist")
	...
	return parse_output(command_output)
end
